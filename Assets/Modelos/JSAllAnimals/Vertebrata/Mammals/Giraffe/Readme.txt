Thank you for downloading Giraffe.

This is a semi realistic 3d model and animations of Giraffe. 
-Models folder contains GiraffeModelLowPoly.FBX, GiraffeModelTowLODs.FBX,
...
Demo folder contains an example use of the Giraffe model. 
