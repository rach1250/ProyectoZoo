...
public class GiraffeCameraScript : MonoBehaviour {
	public GameObject target;
	public float turnSpeed=.2f;
	public GameObject giraffeCamera;
	...
	void Update(){
		...
		CameraRotationX ();
		CameraRotationY ();
		cameraDistance=cameraDistance+10f*Time.deltaTime*Input.GetAxis ("Mouse ScrollWheel");
		giraffeCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}
