...
public class ElephantCameraScript : MonoBehaviour {
	public GameObject target;
	public float turnSpeed=.2f;
	public GameObject elephantCamera;
	...
	void Update(){
		...
		elephantCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}
